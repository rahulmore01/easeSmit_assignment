    ...
    <div className="bg-[#F4FFE8] w-screen h-auto mt-20 px-16">
      <div className="flex justify-start items-start gap-16 pt-14">
        <div className="flex flex-col gap-3">
          <h1 className="uppercase text-2xl w-[230px]">
            subscribe to our newsletter
          </h1>
          <p className="w-[320px] text-[17px] font-light opacity-60">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aliquid ex
            corporis blan.
          </p>
          <input
            className="border-[2px] p-1 pl-4"
            type="text"
        ...
        <div className="flex gap-10 items-start">
          <div className="flex flex-col gap-3">
            <h1 className="uppercase text-2xl w-[230px] mb-4 ">about us</h1>
            <a className="text-[17px] font-medium opacity-50 capitalize cursor-pointer">
              Our Story
            </a>
            <a className="text-[17px] font-medium opacity-50 capitalize cursor-pointer">
              blogs
          ...
          <div className="flex flex-col gap-3">
            <h1 className="uppercase text-2xl w-[230px] mb-4 ">our services</h1>
            <a className="text-[17px] font-medium opacity-50 capitalize cursor-pointer">
              book maali
            </a>
            <a className="text-[17px] font-medium opacity-50 capitalize cursor-pointer">
          ...
          <div className="flex flex-col gap-3 w-[230px]">
            <h1 className="uppercase text-2xl w-[230px] mb-4 ">useful links</h1>
            <a className="text-[17px] font-medium opacity-50 capitalize cursor-pointer">
              my account
            </a>
            <a className="text-[17px] font-medium opacity-50 capitalize cursor-pointer">
          ...
          <div className="flex flex-col gap-3 w-[230px]">
            <h1 className="uppercase text-2xl w-[260px] mb-4 ">get in touch</h1>
            <a className="text-[17px] font-medium opacity-50 capitalize cursor-pointer">
              address f-343, first floor, sushant lok phase-3,
              sector-57,gurgaon,haryana, india 122003
            </a>
            <a className="text-[17px] font-medium opacity-50 capitalize cursor-pointer flex flex-col  justify-start">
              call:
      ...
      <div className="flex flex-col gap-3 mt-6">
        <h1 className="uppercase text-2xl ">chapterone</h1>

        <p className="text-xl mb-2 opacity-60 font-thin">
        ...
        <h3 className="capitalize cursor-pointer text-2xl">follow us on</h3>
      ...
      <div className="h-[100px]">
        ...
        <hr className="border-black opacity-60 mt-4" />
        <p className="pt-4 text-xl opacity-40">
